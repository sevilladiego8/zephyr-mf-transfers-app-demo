...
4. I would probably stick to **Zephyr + NX** for a more fast forward setup of the apps, `less error prone` project and faster module federation setup, because I had to setup new apps manually with other approaches such as **Zaphyr, RsBuild and React**. 

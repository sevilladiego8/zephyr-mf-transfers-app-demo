...
4. I would probably stick to **Zephyr + NX** for a quick setup, a `less error prone` project and a faster module federation configuration, because I had to setup new apps manually with other approaches such as **Zaphyr, RsBuild and React**. Nonetheless, having more control over the setup of your micro-frontends is something that is worth considering if starting a project from scratch.

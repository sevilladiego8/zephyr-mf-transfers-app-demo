...
3. I discovered some issues that blocked me temporarily, but I am not 100% sure if it was my setup or something else.
4. This public example doesn't have a `README.md` [mf-read-rsbuild](https://github.com/ZephyrCloudIO/zephyr-examples/tree/main/vanilla/examples/mf-react-rsbuild-1), adding a readme always serves as a guide to understand the example easier and better
